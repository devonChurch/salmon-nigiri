	    ...
	    _createClass(Board, [{
	        ...
	        value: function replicateBoard() {
	            ...
	            for (var i = 0; i < $tiles.length; i += 1) {
	                ...
	                var $tile = $tiles.eq(i);
	                var key = $tile.attr('id');
	                var color = $tile.attr('data-color-to');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Placement = (function () {
	    ...
	    _createClass(Placement, [{
	        key: 'generateDirections',
	        value: function generateDirections() {
	        ...
	        value: function findPossibilities() {
	            ...
	            var possibilities = {};
	            var keys = Object.keys(this.Board.tiles);
	            ...
	            try {
	                for (var _iterator = keys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    ...
	                    var tile = this.tileProperties(key);
	                    var matches = tile.color === 'white' ? this.placementRelevance(tile) : false;
	        ...
	        key: 'tileProperties',
	        value: function tileProperties(key) {
	        ...
	        key: 'placementRelevance',
	        value: function placementRelevance(tile) {
	            ...
	            try {
	                for (var _iterator2 = this.directions[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                    var direction = _step2.value;
	
	                    var matches = this.siblingRelevance(tile, direction);
	        ...
	        key: 'siblingRelevance',
	        value: function siblingRelevance(properties, direction) {
	            ...
	            var match = this.Reversi.Helper.opponentColor;
	            var flip = [];
	
	            var x = properties.x;
	            var y = properties.y;
	            var color = this.Reversi.Helper.opponentColor;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerOne = (function () {
	    ...
	    _createClass(PlayerOne, [{
	        ...
	        key: 'deactivateListeners',
	        value: function deactivateListeners() {
	...
	var PlayerTwo = (function () {
	    ...
	    _createClass(PlayerTwo, [{
	        ...
	        value: function sortPossibilities(possibilities) {
	            ...
	            try {
	                for (var _iterator = keys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    ...
	                    var possibility = possibilities[key];
	                    var priority = possibility.length;
	                    if (!priorities.hasOwnProperty(priority)) {
	                        priorities[priority] = [];
	                    }
	                    priorities[priority].push(_defineProperty({}, key, possibility));
	                }
	            } catch (err) {
	                _didIteratorError = true;
	                _iteratorError = err;
	        ...
	        value: function pickPriorityTile(possibilities) {
	            ...
	            return this.Reversi.Helper.randomise({ max: max });
	        }
	    }]);
